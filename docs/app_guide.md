...
```typescript
// GET /api/shops/{slug}/admin/orders/{id}
// צריך ליצור endpoint חדש או להרחיב קיים
...
```typescript
// PATCH /api/shops/{slug}/admin/orders/{id}/status
// צריך ליצור endpoint חדש
...
```typescript
// PATCH /api/shops/{slug}/admin/orders/{id}/read
// צריך ליצור endpoint חדש
...
```typescript
// GET /api/shops/{slug}/admin/products
// צריך ליצור endpoint חדש
...
```typescript
// GET /api/shops/{slug}/admin/products/{id}
// צריך ליצור endpoint חדש
...
```typescript
// PATCH /api/shops/{slug}/admin/products/{id}/inventory
// צריך ליצור endpoint חדש - חשוב למובייל!
...
```typescript
// PATCH /api/shops/{slug}/admin/products/{id}/price
// צריך ליצור endpoint חדש
...
```typescript
// GET /api/shops/{slug}/admin/products/barcode/{barcode}
// צריך ליצור endpoint חדש - חשוב מאוד למובייל!
...
```typescript
// GET /api/shops/{slug}/admin/customers
// צריך ליצור endpoint חדש
...
```typescript
// GET /api/shops/{slug}/admin/customers/{id}
// צריך ליצור endpoint חדש
...
```typescript
// GET /api/shops/{slug}/admin/analytics/summary
// צריך ליצור endpoint חדש
...
```typescript
// GET /api/shops/{slug}/admin/analytics/realtime
// צריך ליצור endpoint חדש - עובד עם Redis
...
```typescript
// GET /api/shops/{slug}/admin/discounts
// צריך ליצור endpoint חדש
...
```typescript
// POST /api/shops/{slug}/admin/discounts/quick
// צריך ליצור endpoint חדש - פשוט למובייל
...
```typescript
// GET /api/shops/{slug}/admin/returns
// צריך ליצור endpoint חדש
...
```typescript
// GET /api/shops/{slug}/admin/notifications
// צריך ליצור endpoint חדש
...
```typescript
// PATCH /api/shops/{slug}/admin/notifications/read
// צריך ליצור endpoint חדש
...
```typescript
// POST /api/shops/{slug}/admin/notifications/register-push
// צריך ליצור endpoint חדש
