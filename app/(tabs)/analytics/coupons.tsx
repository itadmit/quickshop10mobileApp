...
const styles = StyleSheet.create({
  ...
  couponInfo: { flex: 1, alignItems: 'flex-end', gap: 2 },
  couponCode: { fontSize: 14, fontFamily: fonts.semiBold, color: dt.colors.ink[950], textAlign: 'right' },
  couponMetaRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  couponMeta: { fontSize: 12, color: dt.colors.ink[500] },
  statusDot: { width: 8, height: 8, borderRadius: 4 },
  usageCol: { alignItems: 'flex-end', minWidth: 60 },
