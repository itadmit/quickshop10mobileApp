...
const styles = StyleSheet.create({
  ...
  totalCard: { flex: 1 },
  totalLabel: { fontSize: 12, color: dt.colors.ink[500], textAlign: 'right', writingDirection: 'rtl' },
  totalValue: { fontSize: 22, fontFamily: fonts.bold, color: dt.colors.ink[950], marginTop: 4, textAlign: 'right', writingDirection: 'rtl' },
  listCard: { },
  ...
  revenueCol: { gap: 2, alignItems: 'flex-start' },
