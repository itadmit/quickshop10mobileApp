...
const styles = StyleSheet.create({
  ...
  itemName: { fontSize: 13, fontFamily: fonts.medium, color: dt.colors.ink[950], textAlign: 'right' },
  itemVariant: { fontSize: 12, color: dt.colors.ink[500] },
  itemMeta: { fontSize: 11, color: dt.colors.ink[400] },
  qtyControl: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
